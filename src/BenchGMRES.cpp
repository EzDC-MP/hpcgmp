...
int BenchGMRES(SparseMatrix_type & A, GMRESSData_type & data, Vector_type & b, Vector_type & x, TestGMRESSData_type & test_data, bool verbose) {
  return BenchGMRES(A, A, data, data, b, x, test_data, verbose);
}
